...
namespace SharpXmppDemo
{
    ...
    public class MainActivity : Activity
    {
        ...
        private string jid = "rgdagostino@klsocial.404la.be";
        private string messageRecipient = "rgdagostino2@klsocial.404la.be";
        ...
        private void button_Click(object sender, System.EventArgs e)
        {
            ...
            button.Text = string.Format("You sent {0} Messages!", messageCount++);
        }
